...
class DataBaruFormLangsungPage extends StatefulWidget {
  ...
  const DataBaruFormLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<DataBaruFormLangsungPage> createState() => _DataBaruFormLangsungPage();
}

class _DataBaruFormLangsungPage extends State<DataBaruFormLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'data_baru_merk': merkController.text,
                              'data_baru_no_reg': noRegController.text,
                              'data_baru_no_seri': noSeriController.text,
                              'data_baru_tahun_pembuatan':
                                  tahunPembuatanController.text,
                              'data_baru_class': classController.text,
                              'data_baru_konstanta': konstantaController.text,
