...
class PemeriksaanKwhMeterFormLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanKwhMeterFormLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanKwhMeterFormLangsungPage> createState() =>
      _PemeriksaanKwhMeterFormLangsungPage();
}

class _PemeriksaanKwhMeterFormLangsungPage
    extends State<PemeriksaanKwhMeterFormLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'kwh_peralatan': selectedperalatan,
                              'kwh_segel': selectedsegel,
                              'kwh_nomor_tahun_kode_segel':
                                  nomorTahunKodeController.text,
                              'kwh_keterangan': keteranganController.text,
                              'kwh_foto_sebelum': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage!.path)
                                      .readAsBytesSync()),
                              'kwh_post_peralatan': selectedpost_peralatan,
                              'kwh_post_segel': selectedpost_segel,
                              'kwh_post_nomor_tahun_kode_segel':
                                  postTahunKodeController.text,
                              'kwh_foto_sesudah': 'data:image/png;base64,' +
