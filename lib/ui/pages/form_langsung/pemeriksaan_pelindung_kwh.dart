...
class PemeriksaanPelindungKwhFormLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanPelindungKwhFormLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanPelindungKwhFormLangsungPage> createState() =>
      _PemeriksaanPelindungKwhFormLangsungPage();
}

class _PemeriksaanPelindungKwhFormLangsungPage
    extends State<PemeriksaanPelindungKwhFormLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'pelindung_kwh_foto_sebelum': imagePath,
                              ...
                              'pelindung_kwh_foto_sesudah': imagePath2,
                            });
