...
class PemeriksaanPapanOkFormLangsungPage extends StatefulWidget {
  ...
  const PemeriksaanPapanOkFormLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanPapanOkFormLangsungPage> createState() =>
      _PemeriksaanPapanOkFormLangsungPage();
}

class _PemeriksaanPapanOkFormLangsungPage
    extends State<PemeriksaanPapanOkFormLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'papan_ok_peralatan': selectedperalatan,
                              'papan_ok_segel': selectedsegel,
