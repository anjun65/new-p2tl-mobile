...
class SaksiFormLangsungPage extends StatefulWidget {
  ...
  const SaksiFormLangsungPage({Key? key, required this.work, this.langsung})
      : super(key: key);

  @override
  State<SaksiFormLangsungPage> createState() => _SaksiFormLangsungPage();
}

class _SaksiFormLangsungPage extends State<SaksiFormLangsungPage> {
