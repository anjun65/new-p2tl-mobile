...
class PemeriksaanPelindungBusbarFormLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanPelindungBusbarFormLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanPelindungBusbarFormLangsungPage> createState() =>
      _PemeriksaanPelindungBusbarFormLangsungPage();
}

class _PemeriksaanPelindungBusbarFormLangsungPage
    extends State<PemeriksaanPelindungBusbarFormLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'busbar_peralatan': selectedperalatan,
                              'busbar_segel': selectedsegel,
                              'busbar_nomor_tahun_kode_segel':
                                  nomorTahunKodeController.text,
                              'busbar_keterangan': keteranganController.text,
                              'busbar_foto_sebelum': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage!.path)
                                      .readAsBytesSync()),
                              'busbar_post_peralatan': selectedpost_peralatan,
                              'busbar_post_segel': selectedpost_segel,
                              'busbar_post_nomor_tahun_kode_segel':
                                  postTahunKodeController.text,
                              'busbar_foto_sesudah': 'data:image/png;base64,' +
