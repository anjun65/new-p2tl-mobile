...
class PemeriksaanTerminalFormTidakLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanTerminalFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanTerminalFormTidakLangsungPage> createState() =>
      _PemeriksaanTerminalFormTidakLangsungPage();
}

class _PemeriksaanTerminalFormTidakLangsungPage
    extends State<PemeriksaanTerminalFormTidakLangsungPage> {
