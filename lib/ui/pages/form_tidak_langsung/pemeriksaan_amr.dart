...
class PemeriksaanAmrFormTidakLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanAmrFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanAmrFormTidakLangsungPage> createState() =>
      _PemeriksaanAmrFormTidakLangsungPage();
}

class _PemeriksaanAmrFormTidakLangsungPage
    extends State<PemeriksaanAmrFormTidakLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'amr_peralatan': selectedperalatan,
                              'amr_segel': selectedsegel,
                              'amr_nomor_tahun_kode_segel':
                                  nomorTahunKodeController.text,
                              'amr_keterangan': keteranganController.text,
                              'amr_foto_sebelum': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage!.path)
                                      .readAsBytesSync()),
                              'amr_post_peralatan': selectedpost_peralatan,
                              'amr_post_segel': selectedpost_segel,
                              'amr_post_nomor_tahun_kode_segel':
                                  postTahunKodeController.text,
                              'amr_foto_sesudah': 'data:image/png;base64,' +
