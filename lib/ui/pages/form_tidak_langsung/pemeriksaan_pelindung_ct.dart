...
class PemeriksaanPelindungCtFormTidakLangsungPage extends StatefulWidget {
  ...
  const PemeriksaanPelindungCtFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanPelindungCtFormTidakLangsungPage> createState() =>
      _PemeriksaanPelindungCtFormTidakLangsungPage();
}

class _PemeriksaanPelindungCtFormTidakLangsungPage
    extends State<PemeriksaanPelindungCtFormTidakLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'pelindung_ct_peralatan': selectedperalatan,
                              'pelindung_ct_segel': selectedsegel,
                            ...
                            if (item != 0) {
                              Navigator.push(context,
                                ...
                                return PemeriksaanSegelKwhFormTidakLangsungPage(
                                  work: widget.work,
                                  id: item,
                                );
                              }));
