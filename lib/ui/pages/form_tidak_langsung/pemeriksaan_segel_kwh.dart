...
class PemeriksaanSegelKwhFormTidakLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanSegelKwhFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanSegelKwhFormTidakLangsungPage> createState() =>
      _PemeriksaanSegelKwhFormTidakLangsungPage();
}

class _PemeriksaanSegelKwhFormTidakLangsungPage
    extends State<PemeriksaanSegelKwhFormTidakLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'segel_peralatan': selectedperalatan,
                              'segel_segel': selectedsegel,
                              'segel_nomor_tahun_kode_segel':
                                  nomorTahunKodeController.text,
                              'segel_keterangan': keteranganController.text,
                              'segel_foto_sebelum': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage!.path)
                                      .readAsBytesSync()),
                              'segel_post_peralatan': selectedpost_peralatan,
                              'segel_post_segel': selectedpost_segel,
                              'segel_post_nomor_tahun_kode_segel':
                                  postTahunKodeController.text,
                              'segel_foto_sesudah': 'data:image/png;base64,' +
