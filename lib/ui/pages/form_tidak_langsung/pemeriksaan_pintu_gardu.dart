...
class PemeriksaanPintuGarduFormTidakLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanPintuGarduFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanPintuGarduFormTidakLangsungPage> createState() =>
      _PemeriksaanPintuGarduFormTidakLangsungPage();
}

class _PemeriksaanPintuGarduFormTidakLangsungPage
    extends State<PemeriksaanPintuGarduFormTidakLangsungPage> {
  ...
  TextEditingController keteranganallController = TextEditingController();
  ...
  bool validate() {
    if (nomorTahunKodeController.text.isEmpty ||
        ...
        keteranganallController.text.isEmpty ||
        selectedImage == null ||
        selectedImage2 == null) {
      return false;
    }
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomFormField(
                        title: 'Keterangan Data Pemeriksaan Keseluruhan',
                        controller: keteranganallController,
                        maxLinesText: 4,
                      ),
                      Center(
                        child: Column(
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'pintu_peralatan': selectedperalatan,
                              'pintu_segel': selectedsegel,
                              'pintu_nomor_tahun_kode_segel':
                                  nomorTahunKodeController.text,
                              'pintu_keterangan': keteranganController.text,
                              'pintu_foto_sebelum': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage!.path)
                                      .readAsBytesSync()),
                              'pintu_post_peralatan': selectedpost_peralatan,
                              'pintu_post_segel': selectedpost_segel,
                              'pintu_post_nomor_tahun_kode_segel':
                                  postTahunKodeController.text,
                              'pintu_foto_sesudah': 'data:image/png;base64,' +
                                  base64Encode(File(selectedImage2!.path)
                                      .readAsBytesSync()),
                              'pintu_keterangan_all':
                                  keteranganallController.text,
                            });
