...
class PemeriksaanTerminalCtFormTidakLangsungPage extends StatefulWidget {
  final WorkModel work;
  final int id;

  const PemeriksaanTerminalCtFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanTerminalCtFormTidakLangsungPage> createState() =>
      _PemeriksaanTerminalCtFormTidakLangsungPage();
}

class _PemeriksaanTerminalCtFormTidakLangsungPage
    extends State<PemeriksaanTerminalCtFormTidakLangsungPage> {
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Pintu Kubikel/Pelindung Terminal CT & Relay',
