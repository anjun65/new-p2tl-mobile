...
class PemeriksaanTerminalVtFormTidakLangsungPage extends StatefulWidget {
  ...
  const PemeriksaanTerminalVtFormTidakLangsungPage({
    Key? key,
    required this.id,
    required this.work,
  }) : super(key: key);
  ...
  @override
  State<PemeriksaanTerminalVtFormTidakLangsungPage> createState() =>
      _PemeriksaanTerminalVtFormTidakLangsungPage();
}

class _PemeriksaanTerminalVtFormTidakLangsungPage
    extends State<PemeriksaanTerminalVtFormTidakLangsungPage> {
                        ...
                        onPressed: () async {
                          if (validate()) {
                            var item = await databaseInstance
                              ...
                              'terminal_vt_peralatan': selectedperalatan,
                              'terminal_vt_segel': selectedsegel,
